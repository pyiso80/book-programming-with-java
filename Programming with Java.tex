...
\fancyhf{}
\fancyhead[LE]{\color{steelblue}\bfseries\mmpdkb\nouppercase{\leftmark}}
\fancyhead[RO]{\color{steelblue}\bfseries\mmpdkb\nouppercase{\rightmark}}
...
\titleformat{\chapter}[display] 
    {\color{MidnightBlue}\normalfont\Huge\bfseries\mmpdkb }{\color{MidnightBlue}{\Huge\mmpdkb\thechapter}}{1ex}
    {\filright} 
...
\newcommand{\todef}[1]{\bfseries{#1} \xspace}
\newcommand{\toem}[1]{\bfseries{#1} \xspace}
