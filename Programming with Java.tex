...
\newcommand{\mymmsubsecttlfnt}          {\fontspec[Script=Myanmar,Scale=.9, BoldFont={Myanmar Angoun}]{Myanmar Angoun}\selectfont}
\newcommand{\myensubsecttlfnt}          {\fontspec[Script=Myanmar,Scale=.9, BoldFont={Myanmar Angoun}]{Myanmar Angoun}\selectfont}
\newcommand{\mymmsubsecttlnumfnt}       {\fontspec[Script=Myanmar,Scale=.9, BoldFont={Myanmar Angoun}]{Myanmar Angoun}\selectfont}
...
\newcommand{\mycodelstcpt}   [1]{{\myenlstcptfnt{#1}}} 
%%%=================================================================================================
...
\captionsetup[subfigure]{labelformat=closing, labelsep=space}
...
\lstnewenvironment{lstcodesimple}[1][]{
  \lstset{
      language     = Java,
      float=htbp,
      backgroundcolor=\color{gray!10!white},
