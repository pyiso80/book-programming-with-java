...
\setlist{nosep}
\setitemize[1]{label=--}
\setenumerate[1]{label={\myen{(}\alph*\myen{)}}}
...
\def\reftextfaceafter{\reftextvario{မျက်နှာချင်းဆိုင်}{နောက်} စာမျက်နှာ}%%
\def\reftextafter {နောက်စာမျက်နှာ}%
\def\reftextfacebefore{ရှေ့စာမျက်နှာ}%
\def\reftextbefore {ရှေ့စာမျက်နှာ}%
\def\reftextcurrent{\reftextvario{ယခု}{လက်ရှိ} စာမျက်နှာ}%
\def\reftextfaraway#1{စာမျက်နှာ~\pageref{#1}}%
\def\reftextpagerange#1#2{on စာမျက်နှာ~\pageref{#1}--\pageref{#2}}%
\def\reftextlabelrange#1#2{\ref{#1} to~\ref{#2}}%
...
\newcommand{\myenchttlfnt}           {\fontspec[Script=Latin,Scale=1, BoldFont={Times New Roman Bold}]{Times New Roman}\selectfont}
...
\newcommand{\myensecttlfnt}          {\fontspec[Script=Latin,Scale=1, BoldFont={Myanmar Angoun}]{Myanmar Angoun}\selectfont}
...
\newcommand{\myensubsecttlfnt}          {\fontspec[Script=Latin,Scale=1, BoldFont={Myanmar Angoun}]{Myanmar Angoun}\selectfont}
...
\newcommand{\myensubsubsecttlfnt}          {\fontspec[Script=Latin,Scale=.8, BoldFont={Myanmar Angoun}]{Myanmar Angoun}\selectfont}
...
\newcommand{\myenpartttlfnt}          {\fontspec[Script=Latin,Scale=0.8, BoldFont={Myanmar Angoun}]{Myanmar Angoun}\selectfont}
...
\newcommand{\myentblhdrfnt}           {\fontspec[Script=Latin,Scale=1, BoldFont={Times New Roman Bold}]{Times New Roman}\selectfont}
...
\newcommand{\mymmfigcptfnt}           {\fontspec[Script=Myanmar,Scale=1, BoldFont={Padauk Bold}]{Padauk}\selectfont}
...
\newcommand{\mymmlstcptfnt}           {\fontspec[Script=Myanmar,Scale=1, BoldFont={Padauk Bold}]{Padauk}\selectfont}
...
\newcommand{\mycodefigcpt}   [1]{{\mycodegeneric{#1}}}
\newcommand{\myenfigcpt}   [1]{{\myenfigcptfnt{#1}}}
\newcommand{\mymmfigcpt}   [1]{{\mymmfigcptfnt{#1}}}

\newcommand{\myenlstcpt}   [1]{{\myenlstcptfnt{#1}}}
\newcommand{\mymmlstcpt} [1]{{\mymmlstcptfnt{#1}}}
\newcommand{\mycodelstcpt}   [1]{{\mycodegeneric{#1}}}
\newcommand{\myLstPlaceHolder}[1]{{\itshape{\mycodegeneric{#1}}}}
...
\newfontface\pgcode[Scale=0.9, BoldFont={Ubuntu Mono Bold}, Script=Latin]{Ubuntu Mono}
...
\lstnewenvironment{lstcodeminimal}[1][]{
  \lstset{
      ...
      breaklines=false,
      tabsize=8,
      basicstyle   = \color{tungsten}\pgcode\addfontfeature{Mapping=no-mapping-ligtex},
...
%\enlargethispage{\baselineskip}
\lstnewenvironment{lstcodelong}[1][1]{
  \lstset{
    language     = Java,
    backgroundcolor=\color{gray!10!white},
    breaklines=true,
...
\newcommand{\enProblemDecomposition}{{\myen{problem decomposition}}\xspace}
\newcommand{\mmProblemDecomposition}{{\myen{problem decomposition}}\xspace}
...
\newcommand{\enIfStatement}{{\mycode{if} \myen{statement}}\xspace}
\newcommand{\enIfElseStatement}{{\mycode{if else} \myen{statement}}\xspace}

\newcommand{\enCondition}{ကွန်ဒီးရှင်း{\myen{condition}}}
\newcommand{\mmCondition}{ကွန်ဒီးရှင်း}

\newcommand{\enHighLevel}{အပေါ်ယံ{\myen{high level}}}
\newcommand{\mmHighLevel}{အပေါ်ယံ}

\newcommand{\enLoop}{{\myen{loop}}\xspace}
\newcommand{\mmLoop}{\myen{loop}\xspace}

\newcommand{\enLoopExits}{\myen{loop}\ ထဲကနေထွက်သွား{(\myen{loop exits})}\xspace}
\newcommand{\mmLoopExits}{\myen{loop}\ ထဲကနေထွက်သွား \xspace}

\newcommand{\enLoopBody}{{\myen{loop} \mmBody}\xspace}
\newcommand{\mmLoopBody}{{\myen{loop} \mmBody}\xspace}

\newcommand{\enTopDown}{{\myen{top-down}}\xspace}
\newcommand{\mmTopDown}{{\myen{top-down}}\xspace}

\newcommand{\enStepWiseRefinement}{တစ်ဆင့်ခြင်း မွမ်းမံခြင်း{\myen{(stepwise refinement)}}\xspace}
\newcommand{\mmStepWiseRefinement}{{\myen{stepwise refinement}}\xspace}

\newcommand{\enInfiniteLoop}{{\myen{infinite loop} \mmBody}\xspace}
\newcommand{\mmInfiniteLoop}{{\myen{infinite loop} \mmBody}\xspace}

\newcommand{\enLoopNeverEntered}{“\enLoop ထဲကို လုံးဝ မဝင်ဘူး”{\myen{(loop is never entered)}}\xspace}
\newcommand{\mmLoopNeverEntered}{{\enLoop ထဲကို မဝင်ဘူး}\xspace}
