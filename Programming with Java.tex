...
\newcommand{\mmpdk}       {\fontspec[Script=Myanmar,Scale=1, BoldFont={Myanmar Tagu}]{Myanmar Tagu}\selectfont}
...
\newcommand{\myttlcodetmp}   {\fontspec[Scale=1, Script=Latin]{Ubuntu Mono}\selectfont}
...
%%% and caption
% For caption
\DeclareCaptionFont{captionfont}{\color{iron}\bfseries\fontspec[Script=Myanmar,Scale=0.9, BoldFont={Pyidaungsu Bold}]{Pyidaungsu Bold}\selectfont}
\captionsetup{singlelinecheck=false,justification=raggedright,font=captionfont}
...
\newfontface\pgcode[Scale=1, BoldFont={Ubuntu Mono Bold}, Script=Latin]{Ubuntu Mono}
\lstset{
  language     = Java,
...
\newcommand{\enrun}{{\myen{run}}}
\newcommand{\mmrun}{\myen{run}}

\newcommand{\enJPL}{{\myen{(Java Programming Language)}}}
\newcommand{\mmJPL}{{\myen{(Java Programming Language)}}}

\newcommand{\enPL}{“ပရိုဂရမ်ရေးရန် အသုံးပြုသည့် ဘာသာစကား”{\myen{(programming language)}}}
\newcommand{\mmPL}{{\myen{programming language}}}
